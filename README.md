...
| | |
|---|---|
| **Layered testing** | 523 tests across 17 contract families — analytic fixtures, decision-rule tests, dynamic invariants, metamorphic properties, golden regressions, pipeline contracts. |
...
python -m pytest -ra          # 521 passed, 2 skipped, ~26 s
```
...
| [`tests/`](tests) | 18 files, 523 tests. |
