...
| | |
|---|---|
| **Layered testing** | 522 tests across 17 contract families — analytic fixtures, decision-rule tests, dynamic invariants, metamorphic properties, golden regressions, pipeline contracts. |
...
python -m pytest -ra          # 522 passed, 0 skipped, 0 warnings
```
...
| [`tests/`](tests) | 18 files, 522 tests, no skips. |
