...
Pedagogical figures illustrating the two-stage signal transformation:
    ...
    Figure 1 — Deterministic distortion by theta (transform_signal)
    Figure 2 — Stochastic noise by rho_s (draw_signal / Dirichlet)
"""
...
def plot_signal_distortion_by_theta(
        ...
        save_prefix: str  = "figure_signal_distortion_theta",
) -> plt.Figure:
    """
...
def plot_signal_noise_by_precision(
        ...
        save_prefix: str = "figure_signal_noise_rhos",
) -> plt.Figure:
    """
