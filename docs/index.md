...
| 2 | **[Validation](validation.md)** | How we know the implementation is coherent — 17 families of checks, 522 tests. |
...
| | |
|---|---|
| Test suite | **522 passed, 0 skipped, 0 warnings** — a [dated local verification](validation.md#verification-snapshot), not a CI result |
