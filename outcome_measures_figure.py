...
--------------------------
Three-column layout:
    Left   : sincere benchmark δ⁰ (bar plot)
    Centre : comparison measures  (ΔCENP, k*, Δd*, Δr')
    Right  : final outcome δᵀ     (bar plot)

The centre column acts as both a visual separator and an information panel.
Bars are ranked highest-to-lowest independently within each panel;
...
if __name__ == "__main__":
    ...
    fig, axes = plot_outcome_measures_bars(
        delta_sincere,
        delta_final,
        save_path="outputs/outcome_measures_bars",
    )
