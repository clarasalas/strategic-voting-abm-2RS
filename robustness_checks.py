...
Run cost (approximate, N=1000 or N=500 for most panels)
---------------------------------------------------------
...
Total   : ~1 540 runs  (~2–4 minutes at 0.1 s/run)
...
Outputs  →  outputs/robustness_checks/
...
OUT_DIR = Path("outputs/robustness_checks")
